...
T1 = table({'FixedPar';'zetasrect';'R0';'h';'eta';'etab';'etacb';'etap';'kappa';'xi';'K';'lc';'zc0_on'},...
        [{FixedPar};zetasrect;R0;h;eta;etab;etacb;etap;kappa0;xi;K;lc;zc0_on],...
        {'fixed volume (V) or free volume (P)';'width of the transition for Rectangle profiles';'radius';'thickness';'shear viscosity';'bulk viscosity';'bending viscosity';'volume viscosity';'bending modulus';'friction';'elastic modulus';'nematic length, in units of R0';'zetac as a spontaneous curvatur on or off'},'VariableNames',{'Parameter','Value','Description'});
...
while t < tmax
    ...
    if t==0
        ...
        [svec, v, P1, sol, vs, dsvs, vkk, tss, vn, dsvn, mss, tns, ds2vn, dV, dX0, Lnew_dt, eps1new_dt, sfun_dt, snewfun_dt, snewvec_dt, Lnew_dthalf, eps1new_dthalf, sfun_dthalf, snewfun_dthalf, snewvec_dthalf, SolFound] ...
            = forcebalance(U, dsU, C1, C2, C, C0, dsC, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, dszetac, zetanem, dszetanem, zetacnem, eta, etab, etacb, etap, eps1abs, xintegral, fext, kappa, dskappa, K, xi, kb, x0b, kp, psi0b, optode, t, dt, Adaptive, FixedPar, P0, thalf_P, tsigma, zc0_on, sgrid);
        tcomp = toc;
    else
        tic
        [svec, v, P1, sol, vs, dsvs, vkk, tss, vn, dsvn, mss, tns, ds2vn, dV, dX0, Lnew_dt, eps1new_dt, sfun_dt, snewfun_dt, snewvec_dt, Lnew_dthalf, eps1new_dthalf, sfun_dthalf, snewfun_dthalf, snewvec_dthalf, SolFound] ...
            = forcebalance(U, dsU, C1, C2, C, C0, dsC, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, dszetac, zetanem, dszetanem, zetacnem, eta, etab, etacb, etap, eps1abs, xintegral, fext, kappa, dskappa, K, xi, kb, x0b, kp, psi0b, optode, t, dt, Adaptive, FixedPar, P0, thalf_P, tsigma, zc0_on, solold, sfun, snewfun);
        tcomp = toc;
    end
