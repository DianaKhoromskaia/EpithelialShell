...
% ControlPar : control parameter/ active effect: 'Tension', 'Bending',
% 'Nematic, 'BendingNematic', 'BendingModulus'
...
% P0 - value of the pressure inside the shape
% thalf_P - half-time of pressure application
...
% ..._Profile - set to 'Sigmoidal', 'Gaussian', 'Rectangle' or 'Linear'
% ..._const - constant offset
% ..._implementation_type - 'Eulerian' or 'Lagrangian'
...
while t < tmax
    ...
    if t==0
        ...
        [svec, v, P1, sol, vs, dsvs, vkk, tss, vn, dsvn, mss, tns, ds2vn, dV, dX0, Lnew_dt, eps1new_dt, sfun_dt, snewfun_dt, snewvec_dt, Lnew_dthalf, eps1new_dthalf, sfun_dthalf, snewfun_dthalf, snewvec_dthalf, SolFound] ...
            = forcebalance(U, dsU, C1, C2, C, C0, dsC, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, dszetac, zetanem, dszetanem, zetacnem, eta, etab, etacb, etap, eps1abs, xintegral, fext, kappa, dskappa, K, xi, optode, t, dt, Adaptive, FixedPar, P0, thalf_P, tsigma, sgrid);
        tcomp = toc;
    else
        tic
        [svec, v, P1, sol, vs, dsvs, vkk, tss, vn, dsvn, mss, tns, ds2vn, dV, dX0, Lnew_dt, eps1new_dt, sfun_dt, snewfun_dt, snewvec_dt, Lnew_dthalf, eps1new_dthalf, sfun_dthalf, snewfun_dthalf, snewvec_dthalf, SolFound] ...
            = forcebalance(U, dsU, C1, C2, C, C0, dsC, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, dszetac, zetanem, dszetanem, zetacnem, eta, etab, etacb, etap, eps1abs, xintegral, fext, kappa, dskappa, K, xi, optode, t, dt, Adaptive, FixedPar, P0, thalf_P, tsigma, solold, sfun, snewfun);
        tcomp = toc;
    end
    ...
    if SolFound
        ...
        if t==0
            [C1_dt, dsC1_dt, C2_dt, C_dt, dsC_dt, X_dt, Psi_dt, Z_dt, U_dt, dsU_dt, kappa_dt, dskappa_dt, zeta_dt, dszeta_dt, zetac_dt, dszetac_dt, zetanem_dt, dszetanem_dt, zetacnem_dt, dszetacnem_dt, xintegral_dt, solnem_dt, s0_dt, s0inv_dt, Q_dt] = ...
                evolvefunctions_t0(svec, zeta_controls, zeta_profiles, zeta_implementation_types, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac, dszetac, zetacnem, dszetacnem, ...
                vs, dsvs, vkk, vn, dsvn, mss, tns, ...
                U, C1, dsC1, C2, C, C0, dsC, kappa, dskappa, X, Psi, Z, snewfun_dt, sfun_dt, t, dt, tsigma, L, Lnew_dt, L0, eps1, eps2, etacb, npoints, dsw0, dswL, lc, Q, dsQ, s0, optode_nem, N_regions, zetasrect, kappa0, write94);
        else
            [C1_dt, dsC1_dt, C2_dt, C_dt, dsC_dt, X_dt, Psi_dt, Z_dt, U_dt, dsU_dt, kappa_dt, dskappa_dt, zeta_dt, dszeta_dt, zetac_dt, dszetac_dt, zetanem_dt, dszetanem_dt, zetacnem_dt, dszetacnem_dt, xintegral_dt, solnem_dt, s0_dt, s0inv_dt, Q_dt] = ...
                evolvefunctions(svec, zeta_controls, zeta_profiles, zeta_implementation_types, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac, dszetac, zetacnem, dszetacnem, ...
                vs, dsvs, vkk, vn, dsvn, mss, tns, ...
        ...
        if strcmp(Adaptive,'On')
            ...
            if t==0
                [C1_dthalf, dsC1_dthalf, C2_dthalf, C_dthalf, dsC_dthalf, X_dthalf, Psi_dthalf, Z_dthalf, U_dthalf, dsU_dthalf, kappa_dthalf, dskappa_dthalf, zeta_dthalf, dszeta_dthalf, zetac_dthalf, dszetac_dthalf, zetanem_dthalf, dszetanem_dthalf, zetacnem_dthalf, dszetacnem_dthalf, xintegral_dthalf, solnem_dthalf, s0_dthalf, s0inv_dthalf, Q_dthalf] = ...
                    evolvefunctions_t0(svec, zeta_controls, zeta_profiles, zeta_implementation_types, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac, dszetac, zetacnem, dszetacnem, ...
                    vs, dsvs, vkk, vn, dsvn, mss, tns, ...
                    U, C1, dsC1, C2, C, C0, dsC, kappa, dskappa, X, Psi, Z, snewfun_dthalf, sfun_dthalf, t, dt/2, tsigma, L, Lnew_dthalf, L0, eps1, eps2, etacb, npoints, dsw0, dswL, lc, Q, dsQ, s0, optode_nem, N_regions, zetasrect, kappa0, write94);
            else
                [C1_dthalf, dsC1_dthalf, C2_dthalf, C_dthalf, dsC_dthalf, X_dthalf, Psi_dthalf, Z_dthalf, U_dthalf, dsU_dthalf, kappa_dthalf, dskappa_dthalf, zeta_dthalf, dszeta_dthalf, zetac_dthalf, dszetac_dthalf, zetanem_dthalf, dszetanem_dthalf, zetacnem_dthalf, dszetacnem_dthalf, xintegral_dthalf, solnem_dthalf, s0_dthalf, s0inv_dthalf, Q_dthalf] = ...
                    evolvefunctions(svec, zeta_controls, zeta_profiles, zeta_implementation_types, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac, dszetac, zetacnem, dszetacnem, ...
                    vs, dsvs, vkk, vn, dsvn, mss, tns, ...
            ...
            [C1_dt2half, dsC1_dt2half, C2_dt2half, C_dt2half, dsC_dt2half, X_dt2half, Psi_dt2half, Z_dt2half, U_dt2half, dsU_dt2half, kappa_dt2half, dskappa_dt2half, zeta_dt2half, dszeta_dt2half, zetac_dt2half, dszetac_dt2half, zetanem_dt2half, dszetanem_dt2half, zetacnem_dt2half, dszetacnem_dt2half, xintegral_dt2half, solnem_dt2half, s0_dt2half, s0inv_dt2half, Q_dt2half] = ...
                evolvefunctions(svec_dt2half, zeta_controls, zeta_profiles, zeta_implementation_types, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac_dthalf, dszetac_dthalf, zetacnem_dthalf, dszetacnem_dthalf, ...
