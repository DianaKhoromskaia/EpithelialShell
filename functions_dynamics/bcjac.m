function [dbcdya, dbcdyb, dbcdp] = bcjac(ya, yb, varpar, U, dsU, C1, C2, C, dsC, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, zetanem, dszetanem, zetacnem, eta, etab,etacb, etap, xintegral, fext, kappa, K, xi, kb, x0b, FixedPar, t, P0, thalf_P, tsigma)
