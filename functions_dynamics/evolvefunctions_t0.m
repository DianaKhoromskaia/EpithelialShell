function [C1new, dsC1new, C2new, Cnew, dsCnew, Xnew, Psinew, Znew, Unew, dsUnew, zetaNew, dszetaNew, zetacNew, dszetacNew, zetanemNew, dszetanemNew, zetacnemNew, dszetacnemNew, xintegral, solnem, s0new, s0inv, Q] = evolvefunctions_t0(svec, zeta_controls, zeta_profiles, zeta_consts, zeta_las, zeta_sigmas, zeta_facs, zeta_thalfs, zetac, dszetac, zetacnem, dszetacnem, vs, dsvs, vkk, vn, dsvn, mss, tns, U, C1, dsC1, C2, C, C0, dsC, kappa, X, Psi, Z, snewfun, sfun, t, dt, tsigma, L, Lnew, L0, eps1, eps2, etacb, npoints, dsw0, lc, Q, dsQ, s0, optode_nem, N_regions, zetasrect)
