...
%% Solving the force balance equations at time t:
SolFound = true;

if t==0 % initialise solver input for t=0
...
elseif t>0 % initialise solver input for t>0 with solution of previous time step
    sol = varargin{1};
    sfun = varargin{2};
    snewfun = varargin{3};
