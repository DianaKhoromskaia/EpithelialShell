function dvds = ode(s, v, varpar, U, dsU, C1, C2, C, C0, dsC, dsC1, Psi, X, Z, X0, L, L0, zeta, dszeta, zetac, dszetac, zetanem, dszetanem, zetacnem, dszetacnem, eta, etab, etacb, etap, xintegral, fext, kappa, dskappa, K, xi, FixedPar, t, P0, thalf_P, P2_on, P2, t0_P2, thalf_P2, tsigma, zc0_on, etacb_DC_on)
...
elseif strcmp(FixedPar,'P')
    P1 = P0*(1-sigmoidal(t,thalf_P,tsigma));
    if P2_on
