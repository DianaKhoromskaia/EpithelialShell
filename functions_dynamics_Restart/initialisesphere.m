function [C1, C2, C, dsC1, dsC2, dsC, Psi, X, Z, X0, xintegral, svec1, U, dsU, Q, dsQ, dsw0, dswL, fs, s0, Qgrid] = initialisesphere(L0, R0, z0, npoints, U0_value)
...
U = griddedInterpolant(svec1, U0_value * ones(size(svec1)), 'linear');
