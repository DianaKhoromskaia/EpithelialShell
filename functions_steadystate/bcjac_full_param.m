function [dbcdya, dbcdyb, dbcdp] = bcjac_full_param(ya, yb, varpar, K, zeta, zetanem, zetacnem, C0, fconst, lc, la, guess, tangentvec, ControlPar, FixedPar, fixedpar)
% Jacobian of the residual function for solution with homogeneous profile (la=L0), in parametric mode
