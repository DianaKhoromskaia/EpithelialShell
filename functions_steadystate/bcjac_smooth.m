function [dbcdya, dbcdyb, dbcdp] = bcjac_smooth(ya, yb, varpar, K, zeta, zetanem, zetacnem, C0, fconst, lc, la, FixedPar, fixedpar, Profile, width)
% Jacobian of the residual function for solution with smooth profile, in non-parametric mode
