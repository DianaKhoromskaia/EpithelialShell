function dvds = ode_smooth(s, v, varpar, K, zeta, zetanem, zetacnem, C0, fconst, lc, la, FixedPar, fixedpar, Profile, width)
% RHS of ode for smooth profiles, non-parametric mode
