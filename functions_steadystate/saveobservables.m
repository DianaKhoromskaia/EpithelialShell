function saveobservables(sol, la, K, controlpar, tcomp, intersec, epsstep, fileID, formatSpec, NonParseq, stepsave1, stepsave2, i, plotting, sequence, moviename, ControlPar, Profile, width)
...
%% save to file on solver grid
    ...
    if i==1
        ...
        %dlmwrite('xplot.dat', Xvec, 'precision', '%6.5f' ,'delimiter', '\t');
        %dlmwrite('zplot.dat', Zvec, 'precision', '%6.5f' ,'delimiter', '\t');
        ...
        %dlmwrite('xplot.dat', Xvec, '-append', 'precision', '%6.5f' ,'delimiter', '\t');
        %dlmwrite('zplot.dat', Zvec, '-append', 'precision', '%6.5f' ,'delimiter', '\t');
